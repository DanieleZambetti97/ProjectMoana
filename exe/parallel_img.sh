...
julia render.jl --scene ${SCENE_FILE} --anim_var ${ANIMATION_VAR} --w ${WIDTH} --h ${HEIGHT} --file_out ${filename} --render_alg ${ALG} --a ${A} --seq ${S} --nrays ${NUM_OF_RAYS}
