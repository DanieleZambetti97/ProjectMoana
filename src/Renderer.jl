...
struct PathTracer_Renderer <: Renderer
    ...
    PathTracer_Renderer(world::World; background_color=RGB(0.f0,0.f0,0.f0), pcg=PCG(), num_of_rays=10, max_depth=2, russian_roulette_limit=3) = new(world, background_color, pcg, num_of_rays, max_depth, russian_roulette_limit)
end
