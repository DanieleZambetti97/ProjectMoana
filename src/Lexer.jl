...
mutable struct InputStream
    ...
    InputStream( stream::IOBuffer, location::SourceLocation = SourceLocation("", Int32(1), Int32(1)), saved_char = '0', saved_location = location, tabulation = 8) = new(stream, location, saved_char, saved_location, tabulation)
end
